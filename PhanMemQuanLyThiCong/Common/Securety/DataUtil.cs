...
namespace PhanMemQuanLyThiCong.Common.Securety
{
    public class DataUtil
    {
        ...
        public static string Key { get; set; } = "PmQLTC@123#";
        ...
        public static string EncryptData(string strOriginal)
        {
            try
            {
                string EncryptionKey = "PhucVinh@123";
        ...
        public static string DecryptData(string strDecrypted)
        {
            string EncryptionKey = "PhucVinh@123";
            try
            {
