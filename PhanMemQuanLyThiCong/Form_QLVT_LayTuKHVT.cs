...
{
    public partial class Form_QLVT_LayTuKHVT : DevExpress.XtraEditors.XtraForm
    {
        public delegate void DE__TRUYENDATA(List<KeHoachVatTu> KHVT);
        public DE__TRUYENDATA m__TRUYENDATA;
        public Form_QLVT_LayTuKHVT()
        {
            InitializeComponent();
        }
        private void Fcn_LoadDuLieu()
        {
            //BindingList<Tbl_ThongTinDuAnViewModel> duan = SharedControls.slke_ThongTinDuAn.Properties.DataSource as BindingList<Tbl_ThongTinDuAnViewModel>;
        ...
        private void Form_QLVT_LayTuKHVT_Load(object sender, EventArgs e)
        {
            Fcn_LoadDuLieu();
        }
    }
